      ...
      <div class="flex flex-col lg:w-1/2 pr-8">
        ...
        <div class="inline-flex leading-normal text-left hyphens-text border-b py-4 pl-4">
          <a
            ...
            href="https://goo.gl/maps/HstjUrp7HnEgkK348"
            target="_blank"
          ...
          >
            ...
            <span class="pl-2 hover:font-semibold">Kyrgyzstan, Bishkek</span>
          </a>
        </div>
        <div class="inline-flex leading-normal text-left hyphens-text border-b py-4 pl-4">
          <a
            class="inline-flex hover:text-blue-700"
            href="https://github.com/AlgoAIBoss"
            target="_blank"
            rel="noopener noreferrer"
          >
            ...
            <span class="pl-2 hover:font-semibold">AlgoAIBoss</span>
          </a>
        </div>
        <div class="inline-flex leading-normal text-left hyphens-text py-4 pl-4">
          <a
            class="inline-flex hover:text-blue-700"
            href="https://www.linkedin.com/in/abboss/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg class="fill-current" style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <span class="pl-2 hover:font-semibold">Abbosjon Madiev</span>
          </a>
        </div>
      </div>
